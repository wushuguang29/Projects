...
class GenearteName
{
     ...
     * @return array ['xm' => '姓名']
     */
    static function full_name($sex = 0, $x = null, $fx = false)
    {
        // 单姓
        ...
        // 获取名
        switch ($sex) {
            case 1: $ming = $ming_m; break;
            case 2: $ming = $ming_f; break;
            default: $ming = array_merge($ming_m, $ming_f); break;
        }
