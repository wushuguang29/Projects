...
Route::get('ceshi', 'index/Index/cehsi');
...
Route::get('index/folder/getImageFolder', 'index/folder/getImageFolder'); //解除文件夹绑定关系
Route::get('index/folder/getImageByFolderId', 'index/folder/getImageByFolderId'); //解除文件夹绑定关系
//综合档案配置
...
Route::post('index/folder/updateSynthesisFolder','index/ArchivesConfiguration/updateSynthesisFolder');//获取有图片的文件夹列表
Route::get('index/folder/deleteSynthesisFolder','index/ArchivesConfiguration/deleteSynthesisFolder');//根据文件夹id获取分页图片列表
